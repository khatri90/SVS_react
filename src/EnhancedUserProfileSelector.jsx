...
const EnhancedUserProfileSelector = ({ 
  profiles, 
  selectedProfile, 
  onProfileChange,
  showSignatureManagement = false 
}) => {
  // State variables
  ...
  useEffect(() => {
    ...
    // If we don't need to manage signatures, no need to fetch them
    if (!showSignatureManagement) return;
    ...
    fetchProfileData();
  }, [selectedProfile, profiles, showSignatureManagement]);
  ...
  return (
    <div>
      ...
      {showSignatureManagement && selectedProfileData && (
        <div 
        ...
        >
          <h3 style={{ color: '#0dd3c5', marginBottom: '15px', fontSize: '1.1rem' }}>
            Manage Reference Signatures for {selectedProfileData.name}
          </h3>
          ...
          <div>
            ...
            {selectedProfileData.signatures && selectedProfileData.signatures.length > 0 ? (
                ...
                {selectedProfileData.signatures.map((signature, index) => (
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      <div>
                        <div style={{ fontSize: '0.9rem' }}>Signature #{index + 1}</div>
              ...
              <div style={{
                ...
                No signatures found for this user. Upload a signature to get started.
              </div>
            )}
          </div>
        </div>
      ...
      {showConfirmDelete && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ color: '#ff4d4d', marginBottom: '10px' }}>Confirm Deletion</h3>
...
export default EnhancedUserProfileSelector;